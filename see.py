	...
	def txt_search(self):
		...
		for file in files:
			...
			if re.search(self.string2, file_text):
				print (Fore.RED +Style.BRIGHT +self.string1, " found in ", Fore.CYAN +Style.BRIGHT +file)
		...
		for file in files:
			...
			for line1 in file_t:
				...
				if re.search(self.string2, line1):
					flag_file= 1
					print (Fore.RED+Style.BRIGHT+self.string1," found in ",Fore.CYAN+Style.BRIGHT+file, " at line number ",Fore.MAGENTA+Style.BRIGHT+str(line_number))
...
def main():
	...
	parser.add_argument('-v', help="Version Number", action='store_const',const=1.0)
